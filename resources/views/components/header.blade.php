...
<body>
  <header>
      ...
      <div class="container-lg d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <div class="ms-auto d-flex header_icon">
            ...
            <!-- Search Form -->
            <a class="i" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
            ...
            <!-- cart-icon -->
            <a class="position-relative" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffcanvas" aria-controls="cartOffcanvas">
    ...
    <!-- search -->
    <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel" style="height:15vh !important;">
      ...
      <div class="offcanvas-body">
        <form action="?c=product" method="post" class="justify-content-center d-flex">
          <input name="search" type="text" placeholder="Search name product" class="form-control search-input me-2 d-flex" style="width:500px !important;">
          <button class="align-items-center d-flex" type="submit" style="border: none; background-color: unset;">
            <i class="icon kosi-icon- kosi-icon-search fs-20"></i>
          </button>
        </form>
      </div>
      ...
      <div class="offcanvas-body">
        <form action="?c=auth&a=login" method="post">
          <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" id="email" autocomplete="username" placeholder="Email">
          </div>
          <div class="mb-3">
          ...
          <a href="#" class="text-decoration-none mb-2 d-block" data-bs-toggle="offcanvas" data-bs-target="#offcanvasForgotPassword" aria-controls="offcanvasForgotPassword">Forgot
            password</a>
          <button type="submit" class="btn btn-dark w-100 ">Sign In</button>
        </form>
        <div class="justify-content-between row mt-3">
          <div class="col-6" style="padding-left: 0px;">
            <button href="#" class="text-decoration-none btn btn-outline-dark w-100" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCreateAccount" aria-controls="offcanvasCreateAccount">Create
              account</button>
          </div>
          <div class="col-6">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCreateAccount" aria-labelledby="offcanvasCreateAccountLabel">
      <div class="offcanvas-header">
      ...
      <div class="offcanvas-body">
        <form action="?c=customer&a=register" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" autocomplete="username" name="email" placeholder="Email">
          </div>
          <div class="mb-3">
            <label for="newPassword" class="form-label">Password</label>
            <input type="password" name="newPassword" class="form-control" autocomplete="new-password" id="newPassword" placeholder="Password">
          </div>
          <div class="mb-3">
            <label for="re-Password" class="form-label">Confirm Password</label>
            <input type="password" class="form-control" autocomplete="new-password" id="rePassword" placeholder="Confirm Password">
          </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasForgotPassword" aria-labelledby="offcanvasForgotPasswordLabel">
      <div class="offcanvas-header">
